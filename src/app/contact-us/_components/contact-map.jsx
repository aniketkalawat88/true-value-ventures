        ...
        <div className="">
            ...
            <div className="flex md:gap-6 max-md:gap-4 md:mt-12 max-md:mt-6">
                ...
                <div>
                    ...
                    <p className="text-[#858587] max-md:text-[14px] md:mt-1.5 max-md:mt-1">+91 98765 43210</p> 
                </div>
            </div>
            <div className="flex md:gap-6 gap-4 md:my-10 sm:my-8 my-6">
                ...
                <div>
                    ...
                    <p className="text-[#858587] max-md:text-[14px] md:mt-1.5 max-md:mt-1">abc<span className='max-sm:block'>@gmail.com</span></p>
                </div>
            </div>
            <div className="flex md:gap-6 gap-4 md:my-10 sm:my-8 my-6">
                ...
                <div>
                    ...
                    <p className="text-[#858587] max-md:text-[14px] md:mt-1.5 max-md:mt-1">Dubai Deira, Port Saeed, Al Sayegh Building  </p>
                </div>
            </div>
        </div>
    </div>
