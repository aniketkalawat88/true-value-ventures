...
export default function Service() {
  ...
  const services = [
    ...
    },
    {
      ...
      imgSrc:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpmdsdh5qPOIDwaVjwIVtGq_XrNie3W8737A&s",
      link: "#",
    },
    {
      title: "Transportation & Customs Clearance",
      description:
        "We provide the best transportation and customs clearance services.",
      imgSrc:
        "https://aptlogistics.com/wp-content/uploads/bfi_thumb/17.10-2-ox1puxe7jl5xek25xbmpcxb0em0gw9m96f2zjyb8vc.jpg",
      link: "#",
    },
  ];
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-sm shadow-primary-main/50">
                ...
                <div className="grid grid-cols-2 border border-primary-main rounded-b-lg mf:text-base text-sm">
                  <button className="bg-primary-main text-white  p-2">
                    Call Now
                  </button>
                  <button className="text-primary-main  p-2">
                    Enquiry Now
                  </button>
                </div>
              </div>
